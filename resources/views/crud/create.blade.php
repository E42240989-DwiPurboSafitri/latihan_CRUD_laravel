...
<head>
  ...
  <style>
    ...
    input[type="file"].form-control{
      height:auto; padding:.55rem .75rem;
    }
...
<div class="shell">
  <div class="card-dark">
    <div class="card-body">
      <h4 class="title">Tambah Data Baru</h4>
      <div class="subtitle">Isi form di bawah, lalu simpan.</div>
      ...
      <form action="{{ route('crud.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="d-grid d-sm-flex gap-2">
          <button type="submit" class="btn btn-glow px-4">Simpan</button>
